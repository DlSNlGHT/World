...
window.WORLD_ENGINE_DIAG = (function() {
  ...
  function collectMemory() {
    ...
    return {
      meta: safe(function () { return { engine: 'memory', extVersion: window.MEMORY_ENGINE_SETTINGS?.VERSION || '0.3.1', collectedAt: new Date().toISOString(), userAgent: navigator.userAgent }; }),
