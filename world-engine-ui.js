...
window.WORLD_ENGINE_UI = (function() {
  ...
  const CHANGELOG = [
    { version: '2.4.2', date: '2026-07-11', items: ['世界状态注入文案改为跨题材的中性表达：统一调整固定标题、事件类型、组织状态与关系、社会评价圈层、经济状态、对立关系及未公开信息措辞；注入末尾的叙事行为规则同步去除古风场景限定。', '仅调整发送给正文模型的注入文本，不修改存档字段、状态枚举或推演 API 数据结构，旧存档可继续使用。'] },
